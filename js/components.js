    ...
    sidebar: `
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="stok.html" class="nav-item"><i class="fa-solid fa-book-open"></i> Informasi Bahan Ajar</a>
                ...
                <div class="nav-group" id="laporanGroup">
                    <div class="group-title">
                      <span><i class="fa-solid fa-file-lines"></i> Laporan</span> 
                ...
                <a href="#" class="nav-item"><i class="fa-solid fa-clock-rotate-left"></i> Histori Transaksi</a>
            </nav>
